...
#include <stddef.h>
#include "blas.h"
#include "quadcopter2_sfun.h"
#include "c2_quadcopter2.h"
#include "mwmathutil.h"
#define CHARTINSTANCE_CHARTNUMBER      (chartInstance->chartNumber)
#define CHARTINSTANCE_INSTANCENUMBER   (chartInstance->instanceNumber)
#include "quadcopter2_sfun_debug_macros.h"
...
static const char * c2_debug_family_names[48] = { "l_qa", "l_r", "m_arm",
  "m_body", "m_rotor", "h_a", "h_b", "h_r", "r", "m", "Ixx", "Iyy", "Izz", "Ix",
  "Iy", "Iz", "J", "Jr_x", "Jr_y", "Jr_z", "Jr_vector", "Jr", "x", "x_d", "y",
  "y_d", "z", "z_d", "gamma1", "gamma_d", "beta1", "beta_d", "alpha1", "alpha_d",
  "gamma", "beta", "alpha", "L_vector", "L", "nargin", "nargout", "U1", "U2",
  "U3", "U4", "omega_r", "statematrix", "f" };

/* Function Declarations */
static void initialize_c2_quadcopter2(SFc2_quadcopter2InstanceStruct
  *chartInstance);
static void initialize_params_c2_quadcopter2(SFc2_quadcopter2InstanceStruct
  *chartInstance);
static void enable_c2_quadcopter2(SFc2_quadcopter2InstanceStruct *chartInstance);
static void disable_c2_quadcopter2(SFc2_quadcopter2InstanceStruct *chartInstance);
static void c2_update_debugger_state_c2_quadcopter2
  (SFc2_quadcopter2InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_quadcopter2
  (SFc2_quadcopter2InstanceStruct *chartInstance);
static void set_sim_state_c2_quadcopter2(SFc2_quadcopter2InstanceStruct
  *chartInstance, const mxArray *c2_st);
static void finalize_c2_quadcopter2(SFc2_quadcopter2InstanceStruct
  *chartInstance);
static void sf_gateway_c2_quadcopter2(SFc2_quadcopter2InstanceStruct
  *chartInstance);
static void c2_chartstep_c2_quadcopter2(SFc2_quadcopter2InstanceStruct
  *chartInstance);
static void initSimStructsc2_quadcopter2(SFc2_quadcopter2InstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber, uint32_T c2_instanceNumber);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static void c2_emlrt_marshallIn(SFc2_quadcopter2InstanceStruct *chartInstance,
  const mxArray *c2_f, const char_T *c2_identifier, real_T c2_y[12]);
static void c2_b_emlrt_marshallIn(SFc2_quadcopter2InstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId, real_T c2_y[12]);
static void c2_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_b_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static real_T c2_c_emlrt_marshallIn(SFc2_quadcopter2InstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_c_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_d_emlrt_marshallIn(SFc2_quadcopter2InstanceStruct *chartInstance,
...
static void c2_eml_scalar_eg(SFc2_quadcopter2InstanceStruct *chartInstance);
static real_T c2_mpower(SFc2_quadcopter2InstanceStruct *chartInstance, real_T
  c2_a);
static void c2_eml_error(SFc2_quadcopter2InstanceStruct *chartInstance);
static real_T c2_mod(SFc2_quadcopter2InstanceStruct *chartInstance, real_T c2_x,
                     real_T c2_y);
static void c2_b_eml_scalar_eg(SFc2_quadcopter2InstanceStruct *chartInstance);
static void c2_eml_xgemm(SFc2_quadcopter2InstanceStruct *chartInstance, real_T
  c2_A[9], real_T c2_B[3], real_T c2_C[3], real_T c2_b_C[3]);
static const mxArray *c2_e_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static int32_T c2_e_emlrt_marshallIn(SFc2_quadcopter2InstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static uint8_T c2_f_emlrt_marshallIn(SFc2_quadcopter2InstanceStruct
  *chartInstance, const mxArray *c2_b_is_active_c2_quadcopter2, const char_T
  *c2_identifier);
static uint8_T c2_g_emlrt_marshallIn(SFc2_quadcopter2InstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_b_eml_xgemm(SFc2_quadcopter2InstanceStruct *chartInstance, real_T
  c2_A[9], real_T c2_B[3], real_T c2_C[3]);
static void init_dsm_address_info(SFc2_quadcopter2InstanceStruct *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_quadcopter2 = 0U;
}
  ...
  (SFc2_quadcopter2InstanceStruct *chartInstance)
{
  ...
  real_T (*c2_f)[12];
  c2_f = (real_T (*)[12])ssGetOutputPortSignal(chartInstance->S, 1);
  c2_st = NULL;
  c2_st = NULL;
  c2_y = NULL;
  ...
  c2_hoistedGlobal = chartInstance->c2_is_active_c2_quadcopter2;
  ...
  *chartInstance, const mxArray *c2_st)
{
  ...
  chartInstance->c2_is_active_c2_quadcopter2 = c2_f_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 1)),
     "is_active_c2_quadcopter2");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_quadcopter2(chartInstance);
  ...
  *chartInstance)
{
  ...
  real_T *c2_U4;
  real_T *c2_omega_r;
  real_T (*c2_statematrix)[12];
  real_T (*c2_f)[12];
  c2_statematrix = (real_T (*)[12])ssGetInputPortSignal(chartInstance->S, 5);
  c2_omega_r = (real_T *)ssGetInputPortSignal(chartInstance->S, 4);
  c2_U4 = (real_T *)ssGetInputPortSignal(chartInstance->S, 3);
  c2_U3 = (real_T *)ssGetInputPortSignal(chartInstance->S, 2);
  ...
  _SFD_DATA_RANGE_CHECK(*c2_U1, 0U);
  chartInstance->c2_sfEvent = CALL_EVENT;
  c2_chartstep_c2_quadcopter2(chartInstance);
  _SFD_SYMBOL_SCOPE_POP();
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_quadcopter2MachineNumber_,
    chartInstance->chartNumber, chartInstance->instanceNumber);
  for (c2_i2 = 0; c2_i2 < 12; c2_i2++) {
    _SFD_DATA_RANGE_CHECK((*c2_f)[c2_i2], 1U);
  }

  _SFD_DATA_RANGE_CHECK(*c2_U2, 2U);
  _SFD_DATA_RANGE_CHECK(*c2_U3, 3U);
  _SFD_DATA_RANGE_CHECK(*c2_U4, 4U);
  _SFD_DATA_RANGE_CHECK(*c2_omega_r, 5U);
  for (c2_i3 = 0; c2_i3 < 12; c2_i3++) {
    _SFD_DATA_RANGE_CHECK((*c2_statematrix)[c2_i3], 6U);
  }
}
  ...
  *chartInstance)
{
  ...
  int32_T c2_i4;
  real_T c2_statematrix[12];
  uint32_T c2_debug_family_var_map[48];
  real_T c2_l_qa;
  real_T c2_l_r;
  real_T c2_m_arm;
  real_T c2_m_body;
  ...
  real_T c2_beta;
  real_T c2_alpha;
  real_T c2_L_vector[3];
  real_T c2_L;
  real_T c2_nargin = 6.0;
  real_T c2_nargout = 1.0;
  real_T c2_f[12];
  int32_T c2_i5;
  static real_T c2_a[9] = { 1.1714010416666668E-6, 0.0, 0.0, 0.0,
    1.1714010416666668E-6, 0.0, 0.0, 0.0, 9.3786458333333336E-5 };

  int32_T c2_i6;
  static real_T c2_dv1[9] = { 6.6673333333333347E-8, 0.0, 0.0, 0.0,
    6.6673333333333347E-8, 0.0, 0.0, 0.0, 1.3333333333333335E-5 };
  ...
  real_T *c2_b_U1;
  real_T (*c2_b_f)[12];
  real_T (*c2_b_statematrix)[12];
  c2_b_statematrix = (real_T (*)[12])ssGetInputPortSignal(chartInstance->S, 5);
  c2_b_omega_r = (real_T *)ssGetInputPortSignal(chartInstance->S, 4);
  c2_b_U4 = (real_T *)ssGetInputPortSignal(chartInstance->S, 3);
  c2_b_U3 = (real_T *)ssGetInputPortSignal(chartInstance->S, 2);
  c2_b_U2 = (real_T *)ssGetInputPortSignal(chartInstance->S, 1);
  c2_b_f = (real_T (*)[12])ssGetOutputPortSignal(chartInstance->S, 1);
  ...
  c2_d_hoistedGlobal = *c2_b_U4;
  c2_e_hoistedGlobal = *c2_b_omega_r;
  c2_U1 = c2_hoistedGlobal;
  c2_U2 = c2_b_hoistedGlobal;
  c2_U3 = c2_c_hoistedGlobal;
  c2_U4 = c2_d_hoistedGlobal;
  c2_omega_r = c2_e_hoistedGlobal;
  for (c2_i4 = 0; c2_i4 < 12; c2_i4++) {
    c2_statematrix[c2_i4] = (*c2_b_statematrix)[c2_i4];
  }

  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 48U, 48U, c2_debug_family_names,
    c2_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_l_qa, 0U, c2_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_l_r, 1U, c2_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_m_arm, 2U, c2_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_m_body, 3U, c2_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_m_rotor, 4U, c2_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_h_a, 5U, c2_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_h_b, 6U, c2_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_h_r, 7U, c2_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_r, 8U, c2_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_m, 9U, c2_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_Ixx, 10U, c2_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_Iyy, 11U, c2_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_Izz, 12U, c2_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_Ix, 13U, c2_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_Iy, 14U, c2_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_Iz, 15U, c2_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(c2_J, 16U, c2_d_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_Jr_x, 17U, c2_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_Jr_y, 18U, c2_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_Jr_z, 19U, c2_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(c2_Jr_vector, 20U, c2_d_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_Jr, 21U, c2_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_x, 22U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_x_d, 23U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_y, 24U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_y_d, 25U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_z, 26U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_z_d, 27U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_gamma1, 28U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_gamma_d, 29U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_beta1, 30U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_beta_d, 31U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_alpha1, 32U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_alpha_d, 33U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_gamma, 34U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_beta, 35U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_alpha, 36U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c2_L_vector, 37U, c2_c_sf_marshallOut,
    c2_c_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_L, 38U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_nargin, 39U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_nargout, 40U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_U1, 41U, c2_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_U2, 42U, c2_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_U3, 43U, c2_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_U4, 44U, c2_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_omega_r, 45U, c2_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(c2_statematrix, 46U, c2_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c2_f, 47U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  CV_EML_FCN(0, 0);
  ...
  c2_Ixx = 1.1714010416666668E-6;
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 18);
  c2_Iyy = 1.1714010416666668E-6;
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 19);
  c2_Izz = 9.3786458333333336E-5;
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 25);
  c2_Ix = 1.1714010416666668E-6;
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 26);
  c2_Iy = 1.1714010416666668E-6;
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 27);
  c2_Iz = 9.3786458333333336E-5;
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 28);
  for (c2_i5 = 0; c2_i5 < 9; c2_i5++) {
    c2_J[c2_i5] = c2_a[c2_i5];
  }

  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 29);
  c2_Jr_x = 1.6668333333333337E-8;
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 30);
  c2_Jr_y = 1.6668333333333337E-8;
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 31);
  c2_Jr_z = 3.3333333333333337E-6;
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 32);
  for (c2_i6 = 0; c2_i6 < 9; c2_i6++) {
    c2_Jr_vector[c2_i6] = c2_dv1[c2_i6];
  }

  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 33);
  c2_Jr = 1.3333666729168439E-5;
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 35);
  c2_x = c2_statematrix[0];
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 36);
  c2_x_d = c2_statematrix[1];
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 37);
  c2_y = c2_statematrix[2];
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 38);
  c2_y_d = c2_statematrix[3];
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 39);
  c2_z = c2_statematrix[4];
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 40);
  c2_z_d = c2_statematrix[5];
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 41);
  c2_gamma1 = c2_statematrix[6];
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 42);
  c2_gamma_d = c2_statematrix[7];
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 43);
  c2_beta1 = c2_statematrix[8];
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 44);
  c2_beta_d = c2_statematrix[9];
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 45);
  c2_alpha1 = c2_statematrix[10];
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 46);
  c2_alpha_d = c2_statematrix[11];
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 48);
  c2_gamma = c2_mod(chartInstance, c2_gamma1, 6.2832);
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 49);
  c2_beta = c2_mod(chartInstance, c2_beta1, 6.2832);
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 50);
  c2_alpha = c2_mod(chartInstance, c2_alpha1, 6.2832);
  ...
  for (c2_i7 = 0; c2_i7 < 3; c2_i7++) {
    c2_L_vector[c2_i7] = 0.0;
  }

  for (c2_i8 = 0; c2_i8 < 3; c2_i8++) {
    c2_L_vector[c2_i8] = 0.0;
  }

  for (c2_i9 = 0; c2_i9 < 9; c2_i9++) {
    c2_dv2[c2_i9] = c2_a[c2_i9];
  }
  ...
  c2_b_eml_xgemm(chartInstance, c2_dv4, c2_dv5, c2_L_vector);
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 53);
  c2_b_x = (c2_mpower(chartInstance, c2_L_vector[0]) + c2_mpower(chartInstance,
             c2_L_vector[1])) + c2_mpower(chartInstance, c2_L_vector[2]);
  c2_L = c2_b_x;
  if (c2_L < 0.0) {
  ...
  c2_mb_x = c2_lb_x;
  c2_nb_x = c2_mb_x;
  c2_e_y = c2_nb_x / 1.1714010416666668E-6;
  c2_e_A = c2_L;
  c2_ob_x = c2_e_A;
  c2_pb_x = c2_ob_x;
  c2_qb_x = c2_pb_x;
  c2_f_y = c2_qb_x / 1.1714010416666668E-6;
  c2_f[0] = c2_x_d;
  c2_f[1] = c2_b_y * (c2_h_x * c2_j_x * c2_l_x + c2_n_x * c2_p_x);
  c2_f[2] = c2_y_d;
  c2_f[3] = c2_c_y * (c2_u_x * c2_w_x * c2_y_x - c2_bb_x * c2_db_x);
  c2_f[4] = c2_z_d;
  c2_f[5] = c2_d_y * c2_ib_x * c2_kb_x - 9.81;
  c2_f[6] = c2_gamma_d;
  c2_f[7] = (c2_beta_d * c2_alpha_d * -79.063492345793179 - 11.382665931556051 *
             c2_beta_d * c2_omega_r) + c2_e_y * c2_U2;
  c2_f[8] = c2_beta_d;
  c2_f[9] = (c2_gamma_d * c2_alpha_d * 79.063492345793179 + 11.382665931556051 *
             c2_gamma_d * c2_omega_r) + c2_f_y * c2_U3;
  c2_f[10] = c2_alpha_d;
  c2_f[11] = c2_gamma_d * c2_beta_d * 0.0 + 10662.520131060142 * c2_U4;
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, -55);
  _SFD_SYMBOL_SCOPE_POP();
  for (c2_i13 = 0; c2_i13 < 12; c2_i13++) {
    (*c2_b_f)[c2_i13] = c2_f[c2_i13];
  }
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_y = NULL;
  SFc2_quadcopter2InstanceStruct *chartInstance;
  chartInstance = (SFc2_quadcopter2InstanceStruct *)chartInstanceVoid;
  c2_mxArrayOutData = NULL;
  for (c2_i14 = 0; c2_i14 < 12; c2_i14++) {
    c2_b_inData[c2_i14] = (*(real_T (*)[12])c2_inData)[c2_i14];
  }
  ...
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId, real_T c2_y[12])
{
  ...
  int32_T c2_i16;
  (void)chartInstance;
  sf_mex_import(c2_parentId, sf_mex_dup(c2_u), c2_dv6, 1, 0, 0U, 1, 0U, 1, 12);
  for (c2_i16 = 0; c2_i16 < 12; c2_i16++) {
    c2_y[c2_i16] = c2_dv6[c2_i16];
  }
  ...
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData)
{
  ...
  for (c2_i17 = 0; c2_i17 < 12; c2_i17++) {
    (*(real_T (*)[12])c2_outData)[c2_i17] = c2_y[c2_i17];
  }
  ...
  *c2_inData)
{
  ...
  for (c2_i18 = 0; c2_i18 < 3; c2_i18++) {
    c2_b_inData[c2_i18] = (*(real_T (*)[3])c2_inData)[c2_i18];
  }
  ...
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData)
{
  ...
  SFc2_quadcopter2InstanceStruct *chartInstance;
  chartInstance = (SFc2_quadcopter2InstanceStruct *)chartInstanceVoid;
  c2_L_vector = sf_mex_dup(c2_mxArrayInData);
  c2_identifier = c2_varName;
  c2_thisId.fIdentifier = c2_identifier;
  c2_thisId.fParent = NULL;
  c2_d_emlrt_marshallIn(chartInstance, sf_mex_dup(c2_L_vector), &c2_thisId, c2_y);
  sf_mex_destroy(&c2_L_vector);
  for (c2_i21 = 0; c2_i21 < 3; c2_i21++) {
    (*(real_T (*)[3])c2_outData)[c2_i21] = c2_y[c2_i21];
  }
...
const mxArray *sf_c2_quadcopter2_get_eml_resolved_functions_info(void)
{
  const mxArray *c2_nameCaptureInfo = NULL;
  c2_nameCaptureInfo = NULL;
  sf_mex_assign(&c2_nameCaptureInfo, sf_mex_createstruct("structure", 2, 51, 1),
                false);
...
static void c2_info_helper(const mxArray **c2_info)
{
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("mod"), "name", "name", 25);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 25);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/mod.m!floatmod"), "context",
                  "context", 33);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("eps"), "name", "name", 33);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 33);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/eps.m"), "context",
                  "context", 35);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("eml_eps"), "name", "name", 35);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 35);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c2_info, sf_mex_duplicatearraysafe(&c2_lhs46), "lhs", "lhs",
                  46);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(""), "context", "context", 47);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("cos"), "name", "name", 47);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 47);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("sin"), "name", "name", 49);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 49);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
                     ...
                     real_T c2_y)
{
  ...
  if (c2_b_y == 0.0) {
    ...
    if (c2_b_y == c2_d_x) {
      ...
      if (c2_c_y <= 2.2204460492503131E-16 * c2_d_y) {
        c2_r = 0.0;
      } else {
        c2_k_x = c2_r;
        c2_l_x = c2_k_x;
        c2_l_x = muDoubleScalarFloor(c2_l_x);
        c2_r = (c2_r - c2_l_x) * c2_b_y;
      }
    }
  }
  ...
  *c2_identifier)
{
  ...
  c2_y = c2_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_quadcopter2), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_quadcopter2);
  return c2_y;
}
...
void sf_c2_quadcopter2_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2803219992U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(848965222U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3523684643U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(867587856U);
}

mxArray *sf_c2_quadcopter2_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("eooVHaUFjrVVFlD0qq2N9");
...
mxArray *sf_c2_quadcopter2_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c2_quadcopter2_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c2_quadcopter2(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"f\",},{M[8],M[0],T\"is_active_c2_quadcopter2\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_quadcopter2_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc2_quadcopter2InstanceStruct *) chartInfo->chartInstance;
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        init_script_number_translation(_quadcopter2MachineNumber_,
          chartInstance->chartNumber,chartInstance->instanceNumber);
        if (chartAlreadyPresent==0) {
          /* this is the first instance */
          sf_debug_set_chart_disable_implicit_casting
            (sfGlobalDebugInstanceStruct,_quadcopter2MachineNumber_,
          ...
          _SFD_SET_DATA_PROPS(5,1,1,0,"omega_r");
          _SFD_SET_DATA_PROPS(6,1,1,0,"statematrix");
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,1839);
...

        {
          ...
          real_T (*c2_f)[12];
          real_T (*c2_statematrix)[12];
          c2_statematrix = (real_T (*)[12])ssGetInputPortSignal(chartInstance->S,
            5);
          c2_omega_r = (real_T *)ssGetInputPortSignal(chartInstance->S, 4);
          c2_U4 = (real_T *)ssGetInputPortSignal(chartInstance->S, 3);
          c2_U3 = (real_T *)ssGetInputPortSignal(chartInstance->S, 2);
          ...
          _SFD_SET_DATA_VALUE_PTR(4U, c2_U4);
          _SFD_SET_DATA_VALUE_PTR(5U, c2_omega_r);
          _SFD_SET_DATA_VALUE_PTR(6U, *c2_statematrix);
        }
      }
    } else {
      sf_debug_reset_current_state_configuration(sfGlobalDebugInstanceStruct,
        _quadcopter2MachineNumber_,chartInstance->chartNumber,
        chartInstance->instanceNumber);
    }
  }
}
...
{
  return "GIjo20ohBVKb58seq3BWTD";
}

static void sf_opaque_initialize_c2_quadcopter2(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_quadcopter2InstanceStruct*) chartInstanceVar)
    ->S,0);
  initialize_params_c2_quadcopter2((SFc2_quadcopter2InstanceStruct*)
    chartInstanceVar);
  initialize_c2_quadcopter2((SFc2_quadcopter2InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c2_quadcopter2(void *chartInstanceVar)
{
  enable_c2_quadcopter2((SFc2_quadcopter2InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c2_quadcopter2(void *chartInstanceVar)
{
  disable_c2_quadcopter2((SFc2_quadcopter2InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c2_quadcopter2(void *chartInstanceVar)
{
  sf_gateway_c2_quadcopter2((SFc2_quadcopter2InstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c2_quadcopter2(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c2_quadcopter2
    ((SFc2_quadcopter2InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c2_quadcopter2();/* state var info */
...
extern void sf_internal_set_sim_state_c2_quadcopter2(SimStruct* S, const mxArray
  *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c2_quadcopter2();/* state var info */
  ...
  set_sim_state_c2_quadcopter2((SFc2_quadcopter2InstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c2_quadcopter2(SimStruct* S)
{
  return sf_internal_get_sim_state_c2_quadcopter2(S);
}

static void sf_opaque_set_sim_state_c2_quadcopter2(SimStruct* S, const mxArray
  *st)
{
  sf_internal_set_sim_state_c2_quadcopter2(S, st);
}

static void sf_opaque_terminate_c2_quadcopter2(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_quadcopter2InstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_quadcopter2_optimization_info();
    }

    finalize_c2_quadcopter2((SFc2_quadcopter2InstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc2_quadcopter2((SFc2_quadcopter2InstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_quadcopter2(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c2_quadcopter2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct = load_quadcopter2_optimization_info();
  ...
  ssSetChecksum0(S,(3791117191U));
  ssSetChecksum1(S,(4132495425U));
  ssSetChecksum2(S,(3362470334U));
  ssSetChecksum3(S,(2334378107U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c2_quadcopter2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_quadcopter2(SimStruct *S)
{
  SFc2_quadcopter2InstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc2_quadcopter2InstanceStruct *)utMalloc(sizeof
    (SFc2_quadcopter2InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc2_quadcopter2InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c2_quadcopter2;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c2_quadcopter2;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c2_quadcopter2;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c2_quadcopter2;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c2_quadcopter2;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c2_quadcopter2;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c2_quadcopter2;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_quadcopter2;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_quadcopter2;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_quadcopter2;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c2_quadcopter2;
...
void c2_quadcopter2_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_quadcopter2(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_quadcopter2(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_quadcopter2(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_quadcopter2_method_dispatcher.\n"
