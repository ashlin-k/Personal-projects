...
static const char * c5_debug_family_names[9] = { "L", "r", "r_d", "s", "s_d",
  "nargin", "nargout", "statematrix", "x" };

/* Function Declarations */
static void initialize_c5_flying_ip_1(SFc5_flying_ip_1InstanceStruct
  *chartInstance);
static void initialize_params_c5_flying_ip_1(SFc5_flying_ip_1InstanceStruct
  *chartInstance);
static void enable_c5_flying_ip_1(SFc5_flying_ip_1InstanceStruct *chartInstance);
static void disable_c5_flying_ip_1(SFc5_flying_ip_1InstanceStruct *chartInstance);
static void c5_update_debugger_state_c5_flying_ip_1
  (SFc5_flying_ip_1InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c5_flying_ip_1
  (SFc5_flying_ip_1InstanceStruct *chartInstance);
static void set_sim_state_c5_flying_ip_1(SFc5_flying_ip_1InstanceStruct
  *chartInstance, const mxArray *c5_st);
static void finalize_c5_flying_ip_1(SFc5_flying_ip_1InstanceStruct
  *chartInstance);
static void sf_gateway_c5_flying_ip_1(SFc5_flying_ip_1InstanceStruct
  *chartInstance);
static void initSimStructsc5_flying_ip_1(SFc5_flying_ip_1InstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c5_machineNumber, uint32_T
  c5_chartNumber, uint32_T c5_instanceNumber);
static const mxArray *c5_sf_marshallOut(void *chartInstanceVoid, void *c5_inData);
static void c5_emlrt_marshallIn(SFc5_flying_ip_1InstanceStruct *chartInstance,
  const mxArray *c5_x, const char_T *c5_identifier, real_T c5_y[4]);
static void c5_b_emlrt_marshallIn(SFc5_flying_ip_1InstanceStruct *chartInstance,
  const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId, real_T c5_y[4]);
static void c5_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData);
static const mxArray *c5_b_sf_marshallOut(void *chartInstanceVoid, void
  *c5_inData);
static real_T c5_c_emlrt_marshallIn(SFc5_flying_ip_1InstanceStruct
...
static real_T c5_mpower(SFc5_flying_ip_1InstanceStruct *chartInstance, real_T
  c5_a);
static void c5_eml_scalar_eg(SFc5_flying_ip_1InstanceStruct *chartInstance);
static const mxArray *c5_c_sf_marshallOut(void *chartInstanceVoid, void
  *c5_inData);
static int32_T c5_d_emlrt_marshallIn(SFc5_flying_ip_1InstanceStruct
  *chartInstance, const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
static void c5_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData);
static uint8_T c5_e_emlrt_marshallIn(SFc5_flying_ip_1InstanceStruct
  *chartInstance, const mxArray *c5_b_is_active_c5_flying_ip_1, const char_T
  *c5_identifier);
static uint8_T c5_f_emlrt_marshallIn(SFc5_flying_ip_1InstanceStruct
  *chartInstance, const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
static void init_dsm_address_info(SFc5_flying_ip_1InstanceStruct *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c5_is_active_c5_flying_ip_1 = 0U;
}
  ...
  *chartInstance, const mxArray *c5_st)
{
  ...
  c5_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c5_u, 0)), "x",
                      c5_dv0);
  for (c5_i1 = 0; c5_i1 < 4; c5_i1++) {
    (*c5_x)[c5_i1] = c5_dv0[c5_i1];
  }

  chartInstance->c5_is_active_c5_flying_ip_1 = c5_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c5_u, 1)),
     "is_active_c5_flying_ip_1");
  sf_mex_destroy(&c5_u);
  c5_update_debugger_state_c5_flying_ip_1(chartInstance);
  ...
  *chartInstance)
{
  ...
  int32_T c5_i5;
  real_T (*c5_b_x)[4];
  real_T (*c5_b_statematrix)[4];
  c5_b_x = (real_T (*)[4])ssGetOutputPortSignal(chartInstance->S, 1);
  c5_b_statematrix = (real_T (*)[4])ssGetInputPortSignal(chartInstance->S, 0);
  _SFD_SYMBOL_SCOPE_PUSH(0U, 0U);
  _sfTime_ = sf_get_time(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 4U, chartInstance->c5_sfEvent);
  for (c5_i2 = 0; c5_i2 < 4; c5_i2++) {
    _SFD_DATA_RANGE_CHECK((*c5_b_statematrix)[c5_i2], 0U);
  }

  chartInstance->c5_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 4U, chartInstance->c5_sfEvent);
  for (c5_i3 = 0; c5_i3 < 4; c5_i3++) {
    c5_statematrix[c5_i3] = (*c5_b_statematrix)[c5_i3];
  }

  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 9U, 9U, c5_debug_family_names,
    c5_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c5_L, 0U, c5_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c5_r, 1U, c5_b_sf_marshallOut,
    c5_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c5_r_d, 2U, c5_b_sf_marshallOut,
    c5_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c5_s, 3U, c5_b_sf_marshallOut,
    c5_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c5_s_d, 4U, c5_b_sf_marshallOut,
    c5_b_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c5_nargout, 6U, c5_b_sf_marshallOut,
    c5_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(c5_statematrix, 7U, c5_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c5_x, 8U, c5_sf_marshallOut,
    c5_sf_marshallIn);
  CV_EML_FCN(0, 0);
  _SFD_EML_CALL(0U, chartInstance->c5_sfEvent, 3);
  c5_L = 0.4;
  _SFD_EML_CALL(0U, chartInstance->c5_sfEvent, 5);
  c5_r = c5_statematrix[0];
  _SFD_EML_CALL(0U, chartInstance->c5_sfEvent, 6);
  c5_r_d = c5_statematrix[1];
  _SFD_EML_CALL(0U, chartInstance->c5_sfEvent, 7);
  c5_s = c5_statematrix[2];
  _SFD_EML_CALL(0U, chartInstance->c5_sfEvent, 8);
  c5_s_d = c5_statematrix[3];
  _SFD_EML_CALL(0U, chartInstance->c5_sfEvent, 10);
  if (CV_EML_IF(0, 1, 0, c5_mpower(chartInstance, c5_r) + c5_mpower
                (chartInstance, c5_s) > c5_mpower(chartInstance, 0.4))) {
  ...
  for (c5_i5 = 0; c5_i5 < 4; c5_i5++) {
    _SFD_DATA_RANGE_CHECK((*c5_b_x)[c5_i5], 1U);
  }
}
...
static const mxArray *c5_sf_marshallOut(void *chartInstanceVoid, void *c5_inData)
{
  ...
  const mxArray *c5_y = NULL;
  SFc5_flying_ip_1InstanceStruct *chartInstance;
  chartInstance = (SFc5_flying_ip_1InstanceStruct *)chartInstanceVoid;
  ...
  const mxArray *c5_x, const char_T *c5_identifier, real_T c5_y[4])
{
  ...
  c5_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c5_x), &c5_thisId, c5_y);
  sf_mex_destroy(&c5_x);
}
  ...
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData)
{
  ...
  for (c5_i9 = 0; c5_i9 < 4; c5_i9++) {
    (*(real_T (*)[4])c5_outData)[c5_i9] = c5_y[c5_i9];
  }
...
const mxArray *sf_c5_flying_ip_1_get_eml_resolved_functions_info(void)
{
  ...
  *c5_identifier)
{
  ...
  c5_y = c5_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c5_b_is_active_c5_flying_ip_1), &c5_thisId);
  sf_mex_destroy(&c5_b_is_active_c5_flying_ip_1);
  return c5_y;
}
...
void sf_c5_flying_ip_1_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c5_flying_ip_1_get_autoinheritance_info(void)
{
...
mxArray *sf_c5_flying_ip_1_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c5_flying_ip_1_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c5_flying_ip_1(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"x\",},{M[8],M[0],T\"is_active_c5_flying_ip_1\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c5_flying_ip_1_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc5_flying_ip_1InstanceStruct *) chartInfo->chartInstance;
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
...

        {
          ...
          real_T (*c5_x)[4];
          c5_x = (real_T (*)[4])ssGetOutputPortSignal(chartInstance->S, 1);
          c5_statematrix = (real_T (*)[4])ssGetInputPortSignal(chartInstance->S,
            0);
          _SFD_SET_DATA_VALUE_PTR(0U, *c5_statematrix);
...
static void sf_opaque_initialize_c5_flying_ip_1(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc5_flying_ip_1InstanceStruct*) chartInstanceVar)
    ->S,0);
  initialize_params_c5_flying_ip_1((SFc5_flying_ip_1InstanceStruct*)
    chartInstanceVar);
  initialize_c5_flying_ip_1((SFc5_flying_ip_1InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c5_flying_ip_1(void *chartInstanceVar)
{
  enable_c5_flying_ip_1((SFc5_flying_ip_1InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c5_flying_ip_1(void *chartInstanceVar)
{
  disable_c5_flying_ip_1((SFc5_flying_ip_1InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c5_flying_ip_1(void *chartInstanceVar)
{
  sf_gateway_c5_flying_ip_1((SFc5_flying_ip_1InstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c5_flying_ip_1(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c5_flying_ip_1
    ((SFc5_flying_ip_1InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c5_flying_ip_1();/* state var info */
...
extern void sf_internal_set_sim_state_c5_flying_ip_1(SimStruct* S, const mxArray
  *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c5_flying_ip_1();/* state var info */
  ...
  set_sim_state_c5_flying_ip_1((SFc5_flying_ip_1InstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c5_flying_ip_1(SimStruct* S)
{
  return sf_internal_get_sim_state_c5_flying_ip_1(S);
}

static void sf_opaque_set_sim_state_c5_flying_ip_1(SimStruct* S, const mxArray
  *st)
{
  sf_internal_set_sim_state_c5_flying_ip_1(S, st);
}

static void sf_opaque_terminate_c5_flying_ip_1(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc5_flying_ip_1InstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c5_flying_ip_1((SFc5_flying_ip_1InstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc5_flying_ip_1((SFc5_flying_ip_1InstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c5_flying_ip_1(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c5_flying_ip_1(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c5_flying_ip_1(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c5_flying_ip_1(SimStruct *S)
{
  SFc5_flying_ip_1InstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc5_flying_ip_1InstanceStruct *)utMalloc(sizeof
    (SFc5_flying_ip_1InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc5_flying_ip_1InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c5_flying_ip_1;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c5_flying_ip_1;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c5_flying_ip_1;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c5_flying_ip_1;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c5_flying_ip_1;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c5_flying_ip_1;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c5_flying_ip_1;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c5_flying_ip_1;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c5_flying_ip_1;
  chartInstance->chartInfo.mdlStart = mdlStart_c5_flying_ip_1;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c5_flying_ip_1;
...
void c5_flying_ip_1_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c5_flying_ip_1(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c5_flying_ip_1(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c5_flying_ip_1(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c5_flying_ip_1_method_dispatcher.\n"
