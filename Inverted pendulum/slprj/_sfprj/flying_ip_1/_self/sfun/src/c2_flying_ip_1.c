...
static const char * c2_debug_family_names[49] = { "g", "l_qa", "l_r", "m_arm",
...
static void initialize_c2_flying_ip_1(SFc2_flying_ip_1InstanceStruct
  *chartInstance);
static void initialize_params_c2_flying_ip_1(SFc2_flying_ip_1InstanceStruct
  *chartInstance);
static void enable_c2_flying_ip_1(SFc2_flying_ip_1InstanceStruct *chartInstance);
static void disable_c2_flying_ip_1(SFc2_flying_ip_1InstanceStruct *chartInstance);
static void c2_update_debugger_state_c2_flying_ip_1
  (SFc2_flying_ip_1InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_flying_ip_1
  (SFc2_flying_ip_1InstanceStruct *chartInstance);
static void set_sim_state_c2_flying_ip_1(SFc2_flying_ip_1InstanceStruct
  *chartInstance, const mxArray *c2_st);
static void finalize_c2_flying_ip_1(SFc2_flying_ip_1InstanceStruct
  *chartInstance);
static void sf_gateway_c2_flying_ip_1(SFc2_flying_ip_1InstanceStruct
  *chartInstance);
static void c2_chartstep_c2_flying_ip_1(SFc2_flying_ip_1InstanceStruct
  *chartInstance);
static void initSimStructsc2_flying_ip_1(SFc2_flying_ip_1InstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber, uint32_T c2_instanceNumber);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static void c2_emlrt_marshallIn(SFc2_flying_ip_1InstanceStruct *chartInstance,
  const mxArray *c2_f, const char_T *c2_identifier, real_T c2_y[12]);
static void c2_b_emlrt_marshallIn(SFc2_flying_ip_1InstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId, real_T c2_y[12]);
static void c2_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_b_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static real_T c2_c_emlrt_marshallIn(SFc2_flying_ip_1InstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_c_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_d_emlrt_marshallIn(SFc2_flying_ip_1InstanceStruct *chartInstance,
...
static void c2_eml_scalar_eg(SFc2_flying_ip_1InstanceStruct *chartInstance);
static real_T c2_mpower(SFc2_flying_ip_1InstanceStruct *chartInstance, real_T
  c2_a);
static void c2_eml_error(SFc2_flying_ip_1InstanceStruct *chartInstance);
static real_T c2_mod(SFc2_flying_ip_1InstanceStruct *chartInstance, real_T c2_x,
                     real_T c2_y);
static void c2_b_eml_scalar_eg(SFc2_flying_ip_1InstanceStruct *chartInstance);
static void c2_eml_xgemm(SFc2_flying_ip_1InstanceStruct *chartInstance, real_T
  c2_A[9], real_T c2_B[3], real_T c2_C[3], real_T c2_b_C[3]);
static const mxArray *c2_e_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static int32_T c2_e_emlrt_marshallIn(SFc2_flying_ip_1InstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static uint8_T c2_f_emlrt_marshallIn(SFc2_flying_ip_1InstanceStruct
  *chartInstance, const mxArray *c2_b_is_active_c2_flying_ip_1, const char_T
  *c2_identifier);
static uint8_T c2_g_emlrt_marshallIn(SFc2_flying_ip_1InstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_b_eml_xgemm(SFc2_flying_ip_1InstanceStruct *chartInstance, real_T
  c2_A[9], real_T c2_B[3], real_T c2_C[3]);
static void init_dsm_address_info(SFc2_flying_ip_1InstanceStruct *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_flying_ip_1 = 0U;
}
  ...
  (SFc2_flying_ip_1InstanceStruct *chartInstance)
{
  ...
  c2_hoistedGlobal = chartInstance->c2_is_active_c2_flying_ip_1;
  ...
  *chartInstance, const mxArray *c2_st)
{
  ...
  chartInstance->c2_is_active_c2_flying_ip_1 = c2_f_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 1)),
     "is_active_c2_flying_ip_1");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_flying_ip_1(chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c2_sfEvent = CALL_EVENT;
  c2_chartstep_c2_flying_ip_1(chartInstance);
  ...
  *chartInstance)
{
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_g, 0U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_l_qa, 1U, c2_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_l_r, 2U, c2_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_m_arm, 3U, c2_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_m_body, 4U, c2_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_m_rotor, 5U, c2_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_h_a, 6U, c2_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_h_b, 7U, c2_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_h_r, 8U, c2_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_r, 9U, c2_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_m, 10U, c2_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_Ixx, 11U, c2_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_Iyy, 12U, c2_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_Izz, 13U, c2_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_Ix, 14U, c2_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_Iy, 15U, c2_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_Iz, 16U, c2_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(c2_J, 17U, c2_d_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_Jr_x, 18U, c2_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_Jr_y, 19U, c2_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_Jr_z, 20U, c2_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(c2_Jr_vector, 21U, c2_d_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_Jr, 22U, c2_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_x, 23U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_x_d, 24U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_y, 25U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_y_d, 26U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_z, 27U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_z_d, 28U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_gamma1, 29U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_gamma_d, 30U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_beta1, 31U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_beta_d, 32U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_alpha1, 33U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_alpha_d, 34U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_gamma, 35U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_beta, 36U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_alpha, 37U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c2_L_vector, 38U, c2_c_sf_marshallOut,
    c2_c_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_L, 39U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_nargin, 40U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_nargout, 41U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_U1, 42U, c2_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_U2, 43U, c2_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_U3, 44U, c2_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_U4, 45U, c2_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_omega_r, 46U, c2_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(c2_statematrix, 47U, c2_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c2_f, 48U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  CV_EML_FCN(0, 0);
  ...
  c2_f[4] = c2_z_d;
  c2_f[5] = c2_d_y * c2_ib_x * c2_kb_x + c2_g;
  c2_f[6] = c2_gamma_d;
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_y = NULL;
  SFc2_flying_ip_1InstanceStruct *chartInstance;
  chartInstance = (SFc2_flying_ip_1InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c2_flying_ip_1_get_eml_resolved_functions_info(void)
{
  ...
  *c2_identifier)
{
  ...
  c2_y = c2_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_flying_ip_1), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_flying_ip_1);
  return c2_y;
}
...
void sf_c2_flying_ip_1_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(4261865585U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(832969019U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1410378446U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1078137496U);
}

mxArray *sf_c2_flying_ip_1_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("iO7Pdvp7FkuyCXerrr8VFE");
...
mxArray *sf_c2_flying_ip_1_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c2_flying_ip_1_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c2_flying_ip_1(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"f\",},{M[8],M[0],T\"is_active_c2_flying_ip_1\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_flying_ip_1_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc2_flying_ip_1InstanceStruct *) chartInfo->chartInstance;
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,1847);
...
{
  return "2wDkw3AjsRIiXazztPmY9C";
}

static void sf_opaque_initialize_c2_flying_ip_1(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_flying_ip_1InstanceStruct*) chartInstanceVar)
    ->S,0);
  initialize_params_c2_flying_ip_1((SFc2_flying_ip_1InstanceStruct*)
    chartInstanceVar);
  initialize_c2_flying_ip_1((SFc2_flying_ip_1InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c2_flying_ip_1(void *chartInstanceVar)
{
  enable_c2_flying_ip_1((SFc2_flying_ip_1InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c2_flying_ip_1(void *chartInstanceVar)
{
  disable_c2_flying_ip_1((SFc2_flying_ip_1InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c2_flying_ip_1(void *chartInstanceVar)
{
  sf_gateway_c2_flying_ip_1((SFc2_flying_ip_1InstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c2_flying_ip_1(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c2_flying_ip_1
    ((SFc2_flying_ip_1InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c2_flying_ip_1();/* state var info */
...
extern void sf_internal_set_sim_state_c2_flying_ip_1(SimStruct* S, const mxArray
  *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c2_flying_ip_1();/* state var info */
  ...
  set_sim_state_c2_flying_ip_1((SFc2_flying_ip_1InstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c2_flying_ip_1(SimStruct* S)
{
  return sf_internal_get_sim_state_c2_flying_ip_1(S);
}

static void sf_opaque_set_sim_state_c2_flying_ip_1(SimStruct* S, const mxArray
  *st)
{
  sf_internal_set_sim_state_c2_flying_ip_1(S, st);
}

static void sf_opaque_terminate_c2_flying_ip_1(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_flying_ip_1InstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c2_flying_ip_1((SFc2_flying_ip_1InstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc2_flying_ip_1((SFc2_flying_ip_1InstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_flying_ip_1(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c2_flying_ip_1(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(830191075U));
  ssSetChecksum1(S,(3746474962U));
  ssSetChecksum2(S,(3075694049U));
  ssSetChecksum3(S,(3745413246U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c2_flying_ip_1(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_flying_ip_1(SimStruct *S)
{
  SFc2_flying_ip_1InstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc2_flying_ip_1InstanceStruct *)utMalloc(sizeof
    (SFc2_flying_ip_1InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc2_flying_ip_1InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c2_flying_ip_1;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c2_flying_ip_1;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c2_flying_ip_1;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c2_flying_ip_1;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c2_flying_ip_1;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c2_flying_ip_1;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c2_flying_ip_1;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_flying_ip_1;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_flying_ip_1;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_flying_ip_1;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c2_flying_ip_1;
...
void c2_flying_ip_1_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_flying_ip_1(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_flying_ip_1(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_flying_ip_1(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_flying_ip_1_method_dispatcher.\n"
