...
% R01 = [0 0 -1; 0 -1 0; -1 0 0]; % inventor
R01 = Rz(th1); % my diagram
R12 = Rz(th2);
R23 = eye(3,3);
R = sym(zeros(3,3,n+1));
R(:,:,1) = R01;
...
syms mL1 mL1_lC1x mL1_lC1y mL1_lC1z IL1xx IL1xy IL1xz IL1yy IL1yz IL1zz IM1;
syms mL2 mL2_lC1x mL2_lC1y mL2_lC1z IL2xx IL2xy IL2xz IL2yy IL2yz IL2zz IM2;
syms mM1 mM2
...
pi1 = [m1; mL1_lC1x; mL1_lC1y; mL1_lC1z; IL1xx; IL1xy; IL1xz; IL1yy; IL1yz; IL1zz; IM1];
pi2 = [m2; mL2_lC1x; mL2_lC1y; mL2_lC1z; IL2xx; IL2xy; IL2xz; IL2yy; IL2yz; IL2zz; IM2];
...
subs(Y, [m1, m2], [mi(1), mi(2)]);
subs(tau, [m1, m2], [mi(1), mi(2)]);
subs(PI, [m1, m2], [mi(1), mi(2)]);
