...
set filepath="C:\Users\Ashlin\Documents\TennisBooker"
...
REM arg 6 is the seconds of the timer
REM arg 7 is the milliseconds of the timer
...
java -jar TennisBooker_summer.jar %times% %courts% %secondPlayer% %hour% %minute% %second% %millisec% > log.txt
